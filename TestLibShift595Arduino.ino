...
void loop()
 { 
   ...
   MyShiftReg.BlinkAllRegisters(5, 100); /* Blink LEDs 5 times with 100ms period                        */
   ...
   MyShiftReg.UpdateAllRegisters();      /* Force register state update to turn ON LEDs 0,1, and 2      */                                
